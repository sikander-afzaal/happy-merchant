...
const Header = () => {
  ...
  return (
    <header className="wrapper  bg-black bg-opacity-70 border-b border-solid px-5 2xl:px-[60px] border-[#434D56] fixed z-50 top-0 left-0">
      {headerToggle && (
        <div
      ...
      <div className="flex justify-between items-center gap-5 h-[88px] w-full">
        ...
        <div className="flex justify-center items-center gap-5">
          <div className="flex justify-center items-center gap-3">
            <a href="https://t.me/HappyMerchantPortal" target="blank">
              <img
                src="/telegram.png"
            ...
            <a href="https://twitter.com/HappyMerchant_" target="blank">
              <img
                src="/twitter.png"
                className="object-contain w-[38px]"
                alt=""
          ...
          <button className="bg-[#f6f6f6] text-[#0A0C0F] shadow-btn font-shock border border-solid border-[#b8b8b8] px-6 py-2  text-base font-bold">
            Buy Now
          </button>
        </div>
      </div>
